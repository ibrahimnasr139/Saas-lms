...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260618195646_UpdateTenantPageVisitTableAgain")]
    partial class UpdateTenantPageVisitTableAgain
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entites.AiAssistantMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Domain.Entites.FileChunk", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entites.FlashCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entites.FlashCardDeck", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entites.FlashCardReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entites.Metadata", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entites.QuizAttempt", b =>
                {
                    ...
                    b.HasIndex("StudentId", "ModuleItemId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entites.StudentAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entites.StudentQuiz", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entites.StudentQuizAttempt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entites.StudentQuizQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entites.TenantPageVisit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TenantId", "VisitorId", "PageUrl")
                        .IsUnique();

                    b.ToTable("TenantPageVisits");
                });
            ...
            modelBuilder.Entity("Domain.Entites.FlashCard", b =>
                {
                    b.HasOne("Domain.Entites.FlashCardDeck", "FlashCardDeck")
                        .WithMany("FlashCards")
            ...
            modelBuilder.Entity("Domain.Entites.FlashCardDeck", b =>
                {
                    b.HasOne("Domain.Entites.StudentChapter", "StudentChapter")
            ...
            modelBuilder.Entity("Domain.Entites.FlashCardReview", b =>
                {
                    b.HasOne("Domain.Entites.FlashCard", "FlashCard")
            ...
            modelBuilder.Entity("Domain.Entites.Lesson", b =>
                {
                    ...
                    b.HasOne("Domain.Entites.File", "File")
                        .WithOne("Lesson")
                        .HasForeignKey("Domain.Entites.Lesson", "VideoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entites.StudentAnswer", b =>
                {
                    b.HasOne("Domain.Entites.StudentQuizAttempt", "StudentQuizAttempt")
                        .WithMany("StudentAnswers")
                        .HasForeignKey("StudentQuizAttemptId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entites.StudentQuizQuestion", "StudentQuizQuestion")
                        .WithMany("StudentAnswers")
            ...
            modelBuilder.Entity("Domain.Entites.StudentQuiz", b =>
                {
                    b.HasOne("Domain.Entites.StudentChapter", "Chapter")
                    ...
                    b.HasOne("Domain.Entites.StudentSubject", "Subject")
                        .WithMany("StudentQuizzes")
                        .HasForeignKey("SubjectId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entites.StudentQuizAttempt", b =>
                {
                    ...
                    b.HasOne("Domain.Entites.StudentQuiz", "StudentQuiz")
                        .WithMany("StudentQuizAttempts")
            ...
            modelBuilder.Entity("Domain.Entites.ModuleItem", b =>
                {
                    b.Navigation("AiAssistantMessages");
